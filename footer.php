                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_footer_part">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="">1 P. Cù Chính Lan, Khương Thượng, Thanh Xuân, Hà Nội, Việt Nam</a></li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="copyright_text">
                            <P>
                                ...
                                </script> All rights reserved <i class="ti-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/profile.php?id=100028100483842" target="_blank">Smobile</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </P>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="footer_icon social_icon">
                            <ul class="list-unstyled">
                                <li><a href="https://www.facebook.com/profile.php?id=100028100483842" class="single_social_icon"><i class="fab fa-facebook-f"></i></a></li>
